    ...
    <section class="wrapper overflow-hidden">
            ...
            <div class="row position-relative">
                <div class="col-lg-8 col-xxl-7 mx-auto position-relative">
                    ...
                    <div class="d-flex justify-content-center" data-cues="slideInDown" data-delay="600">
                        <span><a href="{{ route('references') }}"
                                class="btn btn-lg btn-primary rounded-xl mx-1">Referenciák</a></span>
                        <span><a href="{{ route('request') }}"
                                class="btn btn-lg btn-fuchsia rounded-xl mx-1">Ajánlatkérés</a></span>
                    </div>
                    <!-- /div -->
                </div>
                <!-- /column -->
            ...
            <div class="row gx-md-8 gy-8 text-center mb-8 mb-md-10">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <p class="mb-3">
                        ...
                        Webshop biztonságának<br> ellenőrzése
        ...
        <section class="wrapper pattern-wrapper bg-image section-frame" data-image-src="./assets/img/pattern.png">
            <div class="container py-14 pt-md-16 pt-lg-0 pb-md-12">
                ...
                <!--/.row -->
                <div class="row gx-md-8 gx-lg-12 gy-6 gy-lg-0 mb-1">
                    ...
                    <div class="d-flex justify-content-center pt-10" >
                        ...
                        <span><a href="{{ route('request') }}"
                                class="btn btn-lg btn-primary rounded-xl mx-1">Ajánlatkérés</a></span>
                    </div>
            ...
            <div class="container pt-16 pt-md-18 pb-20 pb-md-18">
                <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center mb-15 mb-md-17">
                    <div class="col-lg-12 position-relative">
                        ...
                        <div class="row">
                            <div class="col-md-11 col-lg-8 col-xl-7 col-xxl-6 mx-auto text-center">
                                <h2 class="display-2 mb-4">Rólunk mondták</h2>
                                <p class="lead fs-lg mb-11">Ügyfeleink véleménye számunkra rendkívül fontos. Íme néhány
                                    gondolat, amit rólunk mondanak</p>
                            </div>
                            <!-- /column -->
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <blockquote class="icon mb-0">
                                                <p>
                                                    “Én nagyon meg voltam elégedve a honlap fejlesztése gyors és rugalmas
                                                    volt. Szakmailag magas színvonalon, baráti hangulatban zajlott a közös
                                                    munka. Sok ötlettel segített a korszerű végeredményt elérni. Én
                                                    mindenkinek bátran ajánlanám”
                                                </p>
                                                <div class="blockquote-details">
                                                    <img class="rounded-circle w-12" src="./assets/img/avatars/markamotor_avatar.png" alt="" />
                                                    <div class="info">
                                ...
                                <div class="item col-md-6 col-xl-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <blockquote class="icon mb-0">
                                                <p>
                                                    “A humanregen.hu egy egyedi és innovatív szolgáltatást nyújt, ezért különösen fontos volt számunkra, hogy a weboldal funkcionalitása és megjelenése tökéletesen tükrözze ezt a különlegességet. Az egyedi foglalási rendszer és a könnyen kezelhető adminisztrációs felület biztosítja a hatékony működést mind az ügyfelek, mind az üzemeltetők számára. Örömmel ajánljuk szolgáltatásainkat mindazoknak, akik professzionális, modern és megbízható webes megoldásokat keresnek!”                                                </p>
                                                <div class="blockquote-details">
                                                    <img class=" w-11" src="./assets/img/avatars/humanregen.png" alt="" />
                                                    <div class="info">
                                ...
                                {{-- <div class="item col-md-6 col-xl-4">
                                    <div class="card">
                                        <div class="card-body">
                                            <span class="ratings five mb-3"></span>
                                            <blockquote class="icon mb-0">
                                                <p>“Weboldalunk átalakítása kiemelkedő színvonalon valósult meg. A régi verzióhoz képest hatalmas előrelépés történt mind dizájn, mind funkcionalitás terén. Az új felület modern, letisztult és könnyen kezelhető, ami nagyban hozzájárul a felhasználói élményhez. A fejlesztés során minden részletre odafigyeltek, így egy igazán professzionális, korszerű és megbízható weboldal született. Csak ajánlani tudjuk mindazoknak, akik magas színvonalú webes megoldásokat keresnek!”</p>
                                                <div class="blockquote-details">
                                                    <img class="rounded-circle w-12" src="./assets/img/avatars/lacok_avatar.png" alt="" />
                                                    <div class="info">
